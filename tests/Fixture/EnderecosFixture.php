...
class EnderecosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'enderecos_ibfk_3' => ['type' => 'foreign', 'columns' => ['estado_id'], 'references' => ['estados', 'id_estado'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'enderecos_ibfk_2' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id_usuarios'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'enderecos_ibfk_1' => ['type' => 'foreign', 'columns' => ['loja_id'], 'references' => ['lojas', 'id_loja'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
