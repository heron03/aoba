...
class TelefonesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'telefones_ibfk_2' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id_usuarios'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'telefones_ibfk_1' => ['type' => 'foreign', 'columns' => ['loja_id'], 'references' => ['lojas', 'id_loja'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
